...
class Sprite(Sprite):
    ...
    def eat(self):
        direction = pygame.math.Vector2(self.closest_sprite.rect.center) - pygame.math.Vector2(player_sprite.rect.center)
        direction.normalize_ip()
        player_sprite.rect.move_ip(direction * player_speed)