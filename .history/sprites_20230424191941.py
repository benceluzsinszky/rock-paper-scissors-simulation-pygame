...
class Sprite(Sprite):
    ...
    def __init__(self, game, character=str, location=tuple) -> None:
        ...
        self.rect = location
        self.cloest_food_distance = None
    ...
    def get_food_distance(self, food):
        for sprite in food:
            distance = math.sqrt((sprite.rect.centerx - sprites.sprites()[0].rect.centerx)**2 + (sprite.rect.centery - sprites.sprites()[0].rect.centery)**2)
